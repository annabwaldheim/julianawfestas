...
<head>
    ...
    <!--
    <script src="bootstrap-5.3.3-dist.zip/bootstrap-5.3.3-dist/js/bootstrap.bundle.min.js"></script>
...
<section class="carrossel">
  <div id="demo" class="carousel slide" data-bs-ride="true">
    ...
    <div class="carousel-inner">                <div class="carousel-item active">
      <img src="img/img-dino-baby.png" alt="Los Angeles" class="d-block" style="width:100%">
    </div>
    <div class="carousel-item">
      <img src="img/img-stitch.png" alt="Chicago" class="d-block" style="width:100%">
    </div>
    <div class="carousel-item">
      <img src="img/img-monica.png" alt="New York" class="d-block" style="width:100%">
    </div>
  </div>
